...
** Workflows
:PROPERTIES:
:HEADER-ARGS: tangle hey.yml
:EXPORT_FILE_NAME: workflows
:END:
...
#+begin_html
<a href="https://github.com/staticaland/literate-iac/actions/workflows/test_aws-auth.yml">
<img alt="OIDC" src="https://github.com/staticaland/literate-iac/actions/workflows/test_aws-auth.yml/badge.svg" />
</a>
#+end_html
